...
export default function Navbar() {
    ...
    return (
        <div className={handjet.className}>
            <nav className={"z-10 top-0 left-0 p-5 w-full flex items-center justify-between"}>
                ...
                <div className={`flex-1 flex space-x-5 px-5 md:px-0 md:space-x-10 max-sm:${isMenuOpen ? 'flex' : 'hidden'} md:justify-center`}>
                    ...
                    <Link href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="hover:underline text-lg md:text-xl lg:text-3xl 2xl:text-4xl">Resume</Link>
                </div>
